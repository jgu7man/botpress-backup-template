...
// Instruction: popAuthorized, answerType
export class GetAnswerContext_NodePrompt {
  static readonly Model = "fast-model";
  static readonly Temperature = 0.3;
  static readonly Version = "1.0";
  static readonly HandleFailure = false;
  static readonly Examples = 5;

  constructor(
    public input = {
      user_input: event.preview,
      interpreted_answer: workflow.interpratedAnswer,
...
- Si no hay respuesta explícita sobre la autorización, clasifica como \`request\`.  `;
  ...
  output(
    ...
    user.popAuthorized = popAuthorized;
  }
}

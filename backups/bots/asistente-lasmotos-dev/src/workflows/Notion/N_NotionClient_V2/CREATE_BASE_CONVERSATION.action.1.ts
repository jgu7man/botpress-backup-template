...
// Node: CREATE_BASE_CONVERSATION - nd-dd1b54487f
// "Generate and Format Conversation Title for Notion Integration" - ins-d94523e4c2
...
workflow.body = {
  ...
  properties: {
    ...
    'Última actualización': createTimestamp()
  }
}

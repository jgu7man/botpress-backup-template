...
// # PrintCard
// Instruction: title, detailsURL, imageURL, formattedPrice
export class PrintCardPrompt {
  static readonly Model = "google-ai__models/gemini-1.5-flash-8b-001";
...
`;
  ...
  output(
    ...
    workflow.detailsURL = detailsURL;
    workflow.formattedPrice = formattedPrice;
    workflow.imageURL = imageURL;
  }
}

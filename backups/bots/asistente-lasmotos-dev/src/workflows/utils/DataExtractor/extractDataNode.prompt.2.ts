...
export class ExtractDataNodePrompt {
  ...
  constructor(
    public input = {
      ...
      Variable_solicitada: conversation.expectedData,
      Data_extrada: workflow.extractedData,
    }
  ) {}
...
`;
  ...
  output(
    ...
    user.brillaBillNumber = brillaBillNumber;
    ...
    conversation.expectedData = expectedData;
  }
}

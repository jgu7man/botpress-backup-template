...
// Instruction: correctedUserInput
export class Knowledge_UnderstandingPrompt {
  ...
  constructor(
    public input = {
      ...
      Knowledge_Understanding: workflow.kbUnderstanding,
    }
  ) {}
...
`;
  ...
  output(
    ...
    workflow.correctedUserInput = correctedUserInput;
  }
}
